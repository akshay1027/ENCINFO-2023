                  ...
                  <div className='bg-cyan-100 rounded-[50px] min-h-[240px] px-12 py-12 flex flex-col text-center xl:flex-row xl:items-center xl:text-left  xl:gap-x-[60px] xl:pb-0'>
                    <div className='flex-1 xl:pr-12'>
                      ...
                      <ul className="list-outside py-3" data-aos='fade-left'>
                        ...
                        <li className="py-3 text-left text-lg text-rose-500 font-semibold "> Maximum of 3 members per team is allowed.</li>
                  ...
                  <div className='bg-cyan-100 rounded-[50px] min-h-[240px] px-12 py-12 flex flex-col text-center xl:flex-row xl:items-center xl:text-left  xl:gap-x-[60px] xl:pb-0'>
                    <div className='flex-1 xl:pr-12'>
                      ...
                      <ul className="list-outside py-3" data-aos='fade-left'>
                        ...
                        <li className="py-3 text-left text-lg text-rose-500 font-semibold ">2. All teams must have at least 3 members and not more than 4 members</li>
                  ...
                  <div className='bg-cyan-100 rounded-[50px] min-h-[240px] px-12 py-12 flex flex-col text-center xl:flex-row xl:items-center xl:text-left  xl:gap-x-[60px] xl:pb-0'>
                    <div className='flex-1 xl:pr-12'>
                      ...
                      <ul className="list-outside py-3" data-aos='fade-left'>
                        ...
                        <li className="py-3 text-left text-lg text-rose-500 font-semibold ">2. All teams must have 5 members.</li>
                  ...
                  <div className='bg-cyan-100 rounded-[50px] min-h-[240px] px-12 py-12 flex flex-col text-center xl:flex-row xl:items-center xl:text-left  xl:gap-x-[60px] xl:pb-0'>
                    <div className='flex-1 xl:pr-12'>
                      ...
                      <ul className="list-outside py-3" data-aos='fade-left'>
                        ...
                        <li className="py-3 text-left text-lg text-rose-500 font-semibold ">2. All teams can have maximum of 3 members.</li>
